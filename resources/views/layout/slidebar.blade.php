...
<script src="{{ asset('public/js/anime.js') }}"></script> 
<script src="{{ asset('public/js/slidebar.js') }}"></script> 
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item active slide1">
                <div class="row"><div class="container">
                    <div class="col-md-3 text-right">
                        <img data-animation="animated zoomInLeft" src="{{asset('public/image/slide.jpg')}}">
                    </div>
            ...
            <div class="item slide4">
                <div class="row"><div class="container">
                    ...
                    <div class="col-md-5 text-right">
                        <img style="max-width: 200px;"  data-animation="animated zoomInLeft" src="{{asset('public/image/slide.jpg')}}">
                    </div>  
                </div></div>
            </div>
            <!-- End Item 4 -->
